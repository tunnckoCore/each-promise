...
* `returns` **{Promise}**: If `iterable` not Array or Object AND no opts.Promise AND no native Promise it THROWS, otherwise ALWAYS returns a promise!  
